...
// //       {/* Products Grid */}
// //       <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4  px-1 gap-y-24 sm:px-6 ">
// //         {products.length > 0 ? (
...
//       const res = await fetch("https://dummyjson.com/products");
//       const data = await res.json();
//       // filter furniture-related items only
//       const furnitureItems = (data.products || []).filter((p: Product) =>
//         p.category?.toLowerCase().includes("furniture")
//       );
//       setProducts(furnitureItems);
//     } catch (error) {
//       console.error("Error fetching furniture:", error);
//     }
//   }
